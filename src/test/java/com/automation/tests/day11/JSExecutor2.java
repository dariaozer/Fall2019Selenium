...
public class JSExecutor2 {
    ...
    //JavaScript executer-- interface that allows to execute javascript code as part of our Selenium Script
    //JavaScript is used to develop front-end development, and supported by every browser and website
    //if something doesn't work in Selenium, we can do it with JavaScript execute.
    //For example: click, scroll, text input.
