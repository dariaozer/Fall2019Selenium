package com.officeHours.OfficeHour3_25_20;
...
public class FrameWorkPractice {
    //I.Q.
    //if you get NoSuchElementException for your test what might be one reason?
    //if it is an Iframe and if I don't use iframe then I would get NoSuchElement Exception
    //I need to switch to iframe
 /*
