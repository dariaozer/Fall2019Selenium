package com.automation.tests.vytrack.practice;
...
public class RegistrationForm {
    ...
    @Test(description = "happy path completing form and submitting")
    public void test1(){
 driver.findElement(firstNameBy).sendKeys("Daria");
 driver.findElement(lastNameBy).sendKeys("Ozer");
 driver.findElement(usernameBy).sendKeys("testuser");
 driver.findElement(passwordBy).sendKeys("1234567890out!");
 ...
 driver.findElement(dateOfBirthBy).sendKeys("06/23/1987");
 ...
 driver.findElement(signUpBy).click();
    ...
    @Test
    public void alphabeticLettersOnlyTest(){
